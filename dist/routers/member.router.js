...
// 초대 생성 (인증 필요)
router.post('/projects/:projectId/invitations', _middlewares_1.authenticate, ..._superstructs_1.CreateInvitationSchema, (0, _middlewares_1.asyncHandler)(memberController.createInvitation));
