...
const invitation_router_1 = __importDefault(require("./invitation.router"));
...
const mailService = new _services_1.MailService();
const projectService = new _services_1.ProjectService(projectRepository, mailService);
