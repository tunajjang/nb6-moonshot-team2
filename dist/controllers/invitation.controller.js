...
class InvitationController {
    constructor(invitationService) {
        // 초대 생성
        this.createInvitation = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
        ...
        this.getInvitationLink = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
        ...
        // 초대 수락 (POST) - API 호출용
        this.acceptInvitation = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const { invitationId } = req.params;
        ...
        // 초대 취소
        this.cancelInvitation = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const { invitationId } = req.params;
            const hostId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id; // 인증 미들웨어에서 설정된 사용자 ID
            if (!hostId) {
        ...
        // 프로젝트의 초대 목록 조회
        this.getInvitationsByProjectId = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const { projectId } = req.params;
        ...
        // 초대 삭제
        this.deleteInvitation = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const { invitationId } = req.params;
            const hostId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id; // 인증 미들웨어에서 설정된 사용자 ID
            if (!hostId) {
        ...
        this.invitationService = invitationService || new _services_1.InvitationService();
    }
}
